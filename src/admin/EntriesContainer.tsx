        ...
        <ul className='rounded border p-4'>
          ...
          <label className='relative mb-4 block'>
            ...
            <input
              ...
              className='block w-full rounded-md border border-slate-300 bg-black py-2 pl-9 pr-3 shadow-sm placeholder:italic placeholder:text-slate-400 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm'
